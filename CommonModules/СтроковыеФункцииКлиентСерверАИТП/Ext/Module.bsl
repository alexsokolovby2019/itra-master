...
//  СокращатьНепечатаемыеСимволы - Булево - признак игнорирования непечатаемых символов
//
// Возвращаемое значение:
...
//  Параметр7        - Строка - подставляемый параметр.
//  Параметр8        - Строка - подставляемый параметр.
//  Параметр9        - Строка - подставляемый параметр.
//
// Возвращаемое значение:
...
//                              Если значение содержит пробелы, то оно должно быть заключено в двойные кавычки (").
//
// Возвращаемое значение:
...
//
// Параметры:
//  Строка	 - 	Строка - строка для транслитерации 
// 
// Возвращаемое значение:
//   - Строка - транслитерированная строка
//
